...
{
    public class ChatsCollection(CoreDb db) : IChats
    {
        private readonly CoreDb db = db;

        public async Task<List<Chat>> GetChats(Guid userId, Guid toUserId, string ViviendaId, CancellationToken cancellationToken)
        {
